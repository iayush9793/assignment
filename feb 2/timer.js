...
function output() {
  document.getElementById("ms").innerText = "0" + miliSec_value + " mS";

  if (second_value.toString().length === 1) {
    document.getElementById("sec").innerText = "0" + second_value + " Sec";
  } else {
    document.getElementById("sec").innerText = second_value + " Sec";
  }

  document.getElementById("min").innerText = "0" + minute_value + " min";
}
